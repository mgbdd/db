...
-- Добавлено определение для medicine_type
DROP TYPE IF EXISTS medicine_type CASCADE;
CREATE TYPE medicine_type AS ENUM (
    'finished',
    'manufactured'
    -- Вы можете добавить сюда другие значения, если они необходимы
    );
...
CREATE TABLE IF NOT EXISTS medicine_order(
                                             ...
                                             production_time INTERVAL CHECK (production_time >= INTERVAL '0 seconds'),
