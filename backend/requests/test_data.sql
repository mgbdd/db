DO $$
    ...
    BEGIN
        ...
        INSERT INTO technology_of_preparation (description)
        VALUES
            ('Смешать ингредиенты и нагреть до 80°C'),
            ('Быстро перемешать с последующим охлаждением'),
            ('Использовать только органические компоненты, минимальное нагревание');
